...
// deviceCodeEndpoint returns the GitHub device code endpoint.
func (c *DeviceFlowClient) deviceCodeEndpoint() string {
	return copilotDeviceCodeURL
}

// tokenEndpoint returns the GitHub token endpoint.
func (c *DeviceFlowClient) tokenEndpoint() string {
	return copilotTokenURL
}

// userinfoEndpoint returns the GitHub userinfo endpoint.
