...
// DoKiroLogin triggers the default Kiro authentication flow (-kiro-login).
// Google/GitHub social login is unavailable to third-party apps, so the
// default is the AWS Builder ID / IAM Identity Center method selection.
//
// Parameters:
