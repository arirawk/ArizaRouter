...
//
// Built-in channels: vertex, aistudio, antigravity, claude, codex, kimi, github-copilot, cursor, qwen, iflow.
...
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		return "codex"
	case "aistudio", "antigravity", "kimi", "github-copilot", "cursor", "qwen", "iflow":
		return provider
	default:
		return provider
	}
