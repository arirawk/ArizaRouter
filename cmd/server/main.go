...
func main() {
	...
	commandMode := vertexImport != "" || antigravityLogin || codexLogin || codexDeviceLogin || claudeLogin || kimiLogin || xaiLogin || githubCopilotLogin || cursorLogin || qwenLogin || iflowLogin || iflowCookie || codeBuddyLogin || codeBuddyIntlLogin
